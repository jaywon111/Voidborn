...
suite('Extension Test Suite', () => {
    ...
    test('Test activate function', async () => {
        ...
        vscode.extensions.getExtension('torresgol10.bootstrap-class-autocomplete')?.activate();
        ...
        assert.strictEqual(statusBarItem.text, '5.3.2');
    });
    vscode.window.showInformationMessage('All tests finished.');
});
//# sourceMappingURL=active-extension.test.js.map