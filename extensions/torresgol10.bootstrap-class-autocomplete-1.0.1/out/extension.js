...
exports.selectBootstrapVersion = exports.deactivate = exports.activate = exports.statusBarItem = void 0;
...
function activate(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand(activateCommand, () => {
    ...
    const disposable = vscode.languages.registerCompletionItemProvider(lenguageSupport, {
        async provideCompletionItems(document, position) {
            const lineText = document.lineAt(position).text;
            if (lineText.lastIndexOf('class=', position.character) === -1 && lineText.lastIndexOf('className=', position.character) === -1) {
                return undefined;
            }
            const classes = await (0, bootstrap_1.getBootstrapClasses)();
    ...
    exports.statusBarItem = vscode.window.createStatusBarItem(vscode.StatusBarAlignment.Left, 1);
    exports.statusBarItem.text = (0, bootstrap_1.getBootstrapVersion)();
    exports.statusBarItem.command = 'extension.selectBootstrapVersion';
    exports.statusBarItem.show();
    context.subscriptions.push(vscode.commands.registerCommand('extension.selectBootstrapVersion', () => {
        selectBootstrapVersion();
    }));
}
exports.activate = activate;
function deactivate() {
    (0, bootstrap_1.removeCacheClasses)();
}
...
function selectBootstrapVersion() {
    ...
    const currentVersion = (0, bootstrap_1.getBootstrapVersion)();
    ...
    version.onDidChangeSelection(selection => {
        if (selection[0]) {
            ...
            exports.statusBarItem.text = selection[0].label;
            /* Cambiamos la version de Bootstrap seleccionada */
            (0, bootstrap_1.setBootstrapVersion)(selection[0].label);
...
exports.selectBootstrapVersion = selectBootstrapVersion;
